...
def parse_signal(text: str) -> dict:
    ...
    symbol_map = [
        ...
        # ── Indices ───────────────────────────────────────────────
        (["NAS100", "NAS", "NASDAQ", "US100"], "NAS100"),
        (["SP500", "SPX"],                   "SPX500"),
        (["DOW", "DJ30"],                    "DJ30"),
        (["FTSE", "UK100"],                  "UK100"),
        (["DAX", "GER30"],                   "GER30"),
        ...
        (["MATICUSD", "MATIC", "POLYGON"],   "MATICUSD"),
        (["SHIBUSD", "SHIB", "SHIBA"],       "SHIBUSD"),
        (["UNIUSD", "UNI", "UNISWAP"],       "UNIUSD"),
        (["LINKUSD", "LINK", "CHAINLINK"],   "LINKUSD"),
        (["LUNAUSD", "LUNA", "TERRA"],       "LUNAUSD"),
        (["ALGOUSD", "ALGO", "ALGORAND"],    "ALGOUSD"),
        (["ATOMUSD", "ATOM", "COSMOS"],      "ATOMUSD"),
    ]
