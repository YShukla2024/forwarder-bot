...
def parse_signal(text: str) -> dict:
    ...
    symbol_map = [
        ...
        (["DAX", "GER30"],            "GER30"),
        (["CAC", "FRA40"],            "FRA40"),
        (["NIKKEI", "JPN225"],          "JPN225"),
        (["HANGSENG", "HK50"],          "HK50"),
        (["SSE", "SHANGHAI"],          "SSE50"),
        (["ASX", "AU200"],             "AU200"),
        (["BTCUSD", "BITCOIN"],         "BTCUSD"),
        (["ETHUSD", "ETHEREUM"],        "ETHUSD"),
        (["LTCUSD", "LITECOIN"],        "LTCUSD"),
        (["XRPUSD", "RIPPLE"],          "XRPUSD"),
        (["ADAUSD", "CARDANO"],         "ADAUSD"),
        (["DOTUSD", "POLKADOT"],        "DOTUSD"),
        (["SOLUSD", "SOLANA"],          "SOLUSD"),
        (["DOGEUSD", "DOGECOIN"],       "DOGEUSD"),
        (["AVAXUSD", "AVALANCHE"],      "AVAXUSD"),
        (["MATICUSD", "POLYGON"],       "MATICUSD"),
        (["SHIBUSD", "SHIBA"],          "SHIBUSD"),
        (["UNIUSD", "UNISWAP"],         "UNIUSD"),
        (["LINKUSD", "CHAINLINK"],      "LINKUSD"),
        (["LUNAUSD", "TERRA"],          "LUNAUSD"),
        (["ALGOUSD", "ALGORAND"],       "ALGOUSD"),
        (["ATOMUSD", "COSMOS"],         "ATOMUSD"),
        (["USOUSD", "USOIL"],        "USOUSD"),
        (["NGUSD", "NATGAS"],        "NGUSD"),
        ...
        (["EURUSD", "EUR/USD"],      "EURUSD"),
        (["GBPUSD", "GBP/USD"],      "GBPUSD"),
        (["CADUSD", "CAD/USD"],      "USDCAD"),
        (["CHFUSD", "CHF/USD"],      "USDCHF"),
        (["JPYUSD", "JPY/USD"],      "USDJPY"),
        (["BTCUSD", "BITCOIN"],         "BTCUSD"),
        (["ETHUSD", "ETHEREUM"],        "ETHUSD"),
        (["LTCUSD", "LITECOIN"],        "LTCUSD"),
        (["XRPUSD", "RIPPLE"],          "XRPUSD"),
        ...
        (["ALGOUSD", "ALGORAND"],       "ALGOUSD"),
        (["ATOMUSD", "COSMOS"],         "ATOMUSD"),
        (["GBPCAD", "GBP/CAD"],      "GBPCAD"),
        (["EURCAD", "EUR/CAD"],      "EURCAD"),
        (["AUDCAD", "AUD/CAD"],      "AUDCAD"),
        (["NZDCAD", "NZD/CAD"],      "NZDCAD"),
        (["USDCAD", "USD/CAD"],      "USDCAD"),
        (["CADJPY", "CAD/JPY"],      "CADJPY"),
        (["CADCHF", "CAD/CHF"],      "CADCHF"),         
